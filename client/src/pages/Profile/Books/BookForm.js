...
function BookForm({
  ...
  return (
    <Modal
      title={formType === "add" ? "Add Tool" : "Update Tool"}
      open={open}
        ...
        <Row gutter={[20]}>
          ...
          <Col span={24}>
            <Form.Item
              ...
              name="description"
              rules={[
                { required: true, message: "Please input tool description" },
              ]}
            >
              <textarea type="text" />
            </Form.Item>
          ...
          <Col span={8}>
            ...
            >
              <select>
                ...
                <option value="Elecson">Elecson</option>
                <option value="Greentech">Greentech</option>
                <option value="Elecson + Greentech">Elecson + Greentech</option>
              </select>
            </Form.Item>
          </Col>
          ...
          <Col span={8}>
            <Form.Item
              label="Total Tools"
              name="totalCopies"
              rules={[{ required: true, message: "Please input total tools" }]}
            >
              <input type="text" />
            </Form.Item>
          </Col>
