      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={6}>
          <div className="shadow p-2">
            ...
            <div className="flex justify-between mt-1">
              <h1 className="text-md">Total Tools</h1>
            ...
            <div className="flex justify-between mt-1">
              <h1 className="text-md">Available Tools</h1>
              <h1>{reports?.books?.availableBooksCopiesCount}</h1>
            </div>

            <div className="flex justify-between mt-1">
              <h1 className="text-md">Issued Tools</h1>
        ...
        <Col span={6}>
          <div className="shadow p-2">
            ...
            <div className="flex justify-between mt-1">
              <h1 className="text-md">Factory Members</h1>
              <h1>{reports?.users?.patronsCount}</h1>
            </div>

            <div className="flex justify-between mt-1">
              <h1 className="text-md">Store Keepers</h1>
